...
<html lang="en">
  ...
  <body id="page-top">
	...
	$id = $_GET['id'];
	$data = mysqli_query($db1,"select * from tbl_tempat where id_tempat='$id'");
	while($d = mysqli_fetch_array($data)){
		?>
		<form method="post" action="updatetem.php">
        
			<table>
				<tr>			
					<td>Nama</td>
					<td>
					<input type="hidden" name="id" value="<?php echo $d['id_tempat']; ?>">
						<input type="text" name="nama" value="<?php echo $d['nama_tempat']; ?>">
					</td>
				</tr>
        <tr>
					<td>Inisial</td>
					<td><input type="text" name="inisial" value="<?php echo $d['inisial_tempat']; ?>"></td>
				</tr>
				<tr>
					<td>Penanggung Jawab</td>
					<td><input type="text" name="pnj_jwb" value="<?php echo $d['peng_jwb_tempat']; ?>"></td>
				</tr>
				<tr>
					<td>Alamat</td>
					<td><input type="text" name="alamat" value="<?php echo $d['alamat_tempat']; ?>"></td>
				</tr>
				<tr>
					<td></td>
