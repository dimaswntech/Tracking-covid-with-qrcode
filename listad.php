...
<html lang="en">
  ...
  <body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <a href="cetakdata.php">Download PDF</a>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                        ...
                        <th>Email</th>
                        <th>Surat Test</th>
                        <th>Waktu Rapid<br>Test</th>
                        <th>Lokasi/Tempat Rapid</th>
                        <th>Hasil Test</th>
                        <th>Waktu Tersisa<br>Test</th>
                        <th>Alamat</th>
                        <th>Umur</th>
                        <th>QR Code</th>
                        <th>Kota</th>
                  ...
                  <?php
                    ...
                    while ($row = $res1->fetch_assoc()) {
                      ...
                      $aesfile=$row['aesfile'];
                      $aesqr=$row['aesqr'];
                      $tglrpd=$row['waktu_rapid'];
                      $lokrpd=$row['alamat_rapid'];
                      $hslrpd=$row['hasil_rapid'];
                  ...
                  <tr>
                      <td><?php echo $no++; ?></td>
                      <td>
                      <form method="post" action="listin.php">
                      <input type="hidden" name="username" value="<?php echo $row['username']; ?>">
                      <input type="submit"value="<?php echo $username; ?>" style="background: none;
	color: inherit;
	border: none;
	padding: 0;
	font: inherit;
	...
	outline: inherit;">
                      ...
                      <td><?php echo $tglrpd; ?></td>
                      <td><?php echo $lokrpd; ?></td>
                      <td>
                      <?php
                        if($hslrpd == "Negatif"){
                          echo $hslrpd;
                        }elseif($hslrpd == "Positif"){
                          echo $hslrpd;?>
                          <form method="post" action="listin.php">
                      <input type="hidden" name="username" value="<?php echo $row['username']; ?>">
                      <b>Track <input type="submit"value="<?php echo $username; ?>" style="background: none;
	color: inherit;
	border: none;
	padding: 0;
	font: inherit;
