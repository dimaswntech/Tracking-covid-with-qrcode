                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                    ...
                    while ($row = $res1->fetch_assoc()) {
                      ...
                      $inisial = $row['inisial_tempat'];
                      $peng_jwb = $row['peng_jwb_tempat'];
                  ...
                  <tr>
                      <td><?php echo $no++; ?></td>
                      <td><?php echo $name; ?></td>
                      <td><?php echo $inisial; ?></td>
                      <td><?php echo $peng_jwb; ?></td>
                      <td><?php echo $alamat; ?></td>
                      <td>
                      <a href="edittem.php?id=<?php echo $row['id_tempat']; ?>">EDIT</a>
                      <a href="hapustem.php?id=<?php echo $row['id_tempat']; ?>">HAPUS</a>
                      </td>
                  </tr>
                  <?php } ?>
                  </tbody>
