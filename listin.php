...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="dasadp.php">Pimpinan Covid - 19</a>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="dasadp.php">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="lista.php">List Admin</a>
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Data Tabel Admin</div>
            <div class="card-body">
              <div class="table-responsive">
              <a href="download-pdf.php">Download PDF</a>
              <a href="tambahmin.php">Tambah</a>
              <a href="listad.php">Kembali</a>
                  ...
                  <?php
                   ...
                   <tr>
                       ...
                       <form method="POST" action="kontak.php">
                          <input type="hidden" value="<?php echo $qr; ?>" name="qruser">
                          <input type="hidden" value="<?php echo $waktu; ?>" name="waktuuser">
                          <input type="hidden" value="<?php echo $nama_tempat; ?>" name="tempatuser">
                          <b>Track <input type="submit"value="<?php echo $nama_tempat; ?>" style="background: none;
	color: inherit;
	border: none;
	padding: 0;
	font: inherit;
