...
<html lang="en">
  ...
  <body id="page-top">
	...
	$id = $_GET['id'];
	$data = mysqli_query($db1,"select * from tbl_admin where id='$id'");
	while($d = mysqli_fetch_array($data)){
		?>
		<form method="post" action="updatemin.php">
			...
			<table>
				...
				<tr>
					<td>Name</td>
					<td><input type="text" name="name" value="<?php echo $d['name_admin']; ?>"></td>
				</tr>
				<tr>
					<td>Password</td>
