...
<html lang="en">
  ...
  <body id="page-top">
	...
	$id = $_GET['id'];
	$data = mysqli_query($db1,"select * from tbl_petugas where id_petugas='$id'");
	while($d = mysqli_fetch_array($data)){
		...
		<form method="post" action="updatepet.php">
			...
			<table>
				...
				<tr>
					<td>Tempat Petugas</td>
					<td><input type="text" name="tempat_tugas" value="<?php echo $d['tempat_tugas']; ?>"></td>
				</tr>
				<tr>
					<td></td>
