...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <tr>			
			...
			<tr>
				<td>File Hasil Test</td>
				<td><input type="file" name="filehasil"></td>
			</tr>
      <tr>
				<td>Tanggal Rapid Test</td>
				<td><input type="date" name="tanggalrapid"></td>
			</tr>
      <tr>
				<td>Tempat/Lokasi Rapid Test</td>
				<td><input type="text" name="lokasirapid"></td>
			</tr>
      <tr>
				<td>Hasil Rapid Test</td>
				<td><input type="text" name="hasilrapid"></td>
			</tr>      
			<tr>
				<td>Umur</td>
