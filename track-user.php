...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.html">Admin Covid - 19</a>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <a class="dropdown-item" href="listad.php">List Pengguna</a>
            ...
            <a class="dropdown-item" href="track-user.php">View Traffic</a>
        ...
        <li class="nav-item">
          <a class="nav-link" href="track-user.php">
            <i class="fas fa-fw fa-table"></i>
            <span>Data Track User</span></a>
        </li>
      </ul>
