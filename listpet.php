              ...
              <a href="tambahpet.php">Tambah</a>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <td><?php echo $no++; ?></td>
                      ...
                      <td>
                      <a href="editpet.php?id=<?php echo $row['id_petugas']; ?>">EDIT</a>
                      <a href="hapuspet.php?id=<?php echo $row['id_petugas']; ?>">HAPUS</a>
                      </td>
                  </tr>
                  <?php } ?>
                  </tbody>
